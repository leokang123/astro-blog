---
title: "14_TCPIP_Chapter_14_TCP_Timeout_and_Retransmission"
order: 14
pubDatetime: 2026-05-16T14:51:38+09:00
modDatetime: 2026-05-16T15:06:02+09:00
description: "Chapter 14 TCP Timeout 정리노트입니다."
tags:
  - cs전공책
  - ComputerNetwork
---
...
<p align="center"><sub>Figure 14-1 · PDF p. 688 · timer-based retransmission과 timeout doubling 예제</sub></p>
...
<p align="center"><sub>Figure 14-2 · PDF p. 697 · Linux에서 TSOPT 기반 RTT sample로 srtt/rttvar/RTO를 갱신하는 흐름</sub></p>
...
<p align="center"><sub>Figure 14-3 · PDF p. 701 · standard RTO와 Linux RTO estimator의 synthetic sample 대응 비교</sub></p>
...
<p align="center"><sub>Figure 14-4 · PDF p. 702 · reordering 상황에서 TSER가 window를 advance한 마지막 segment의 timestamp를 반영하는 방식</sub></p>
...
<p align="center"><sub>Figure 14-5 · PDF p. 705 · segment 1401 loss로 timer-based retransmission이 발생하는 예제</sub></p>
...
<p align="center"><sub>Figure 14-6 · PDF p. 707 · duplicate ACK 3개로 fast retransmit이 발생하고 partial ACK가 다음 retransmission을 유발하는 흐름</sub></p>
...
<p align="center"><sub>Figure 14-7 · PDF p. 708 · Wireshark trace에서 packet 50과 66이 retransmission으로 표시되는 예</sub></p>
...
<p align="center"><sub>Figure 14-8 · PDF p. 709 · duplicate ACK 3개가 fast retransmit trigger가 되는 Flow Graph</sub></p>
...
<p align="center"><sub>Figure 14-9 · PDF p. 713 · SACK 정보로 같은 RTT 안에서 두 번째 missing segment까지 복구하는 fast retransmit</sub></p>
...
<p align="center"><sub>Figure 14-10 · PDF p. 714 · SYN에서 SACK-Permitted option이 교환되는 connection setup</sub></p>
...
<p align="center"><sub>Figure 14-11 · PDF p. 715 · SACK block의 left edge/right edge가 out-of-order range를 나타내는 예</sub></p>
...
<p align="center"><sub>Figure 14-12 · PDF p. 717 · delay spike로 spurious timeout이 발생하고 go-back-N식 낭비가 생기는 예</sub></p>
...
<p align="center"><sub>Figure 14-13 · PDF p. 723 · mild reordering은 무시되지만 severe reordering은 spurious fast retransmit을 유발하는 예</sub></p>
...
<p align="center"><sub>Figure 14-14 · PDF p. 723 · packet duplication이 duplicate ACK를 만들어 spurious fast retransmission을 유발하는 예</sub></p>
