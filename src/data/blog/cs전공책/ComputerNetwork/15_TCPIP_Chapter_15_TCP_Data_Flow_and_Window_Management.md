---
title: "15_TCPIP_Chapter_15_TCP_Data_Flow_and_Window_Management"
order: 15
pubDatetime: 2026-05-16T15:06:42+09:00
modDatetime: 2026-05-16T15:43:52+09:00
description: "Chapter15 TCP Data Flow 정리본입니다."
tags:
  - cs전공책
  - ComputerNetwork
---
...
<p align="center"><sub>Figure 15-1 · PDF p. 732 · interactive keystroke에서 ACK와 echo가 분리되거나 piggyback되는 흐름</sub></p>
...
<p align="center"><sub>Figure 15-6 · PDF p. 737 · Nagle disabled/enabled에서 small packet 수와 delay가 달라지는 비교</sub></p>
...
<p align="center"><sub>Figure 15-7 · PDF p. 738 · delayed ACK와 Nagle algorithm 조합이 만드는 temporary deadlock</sub></p>
...
<p align="center"><sub>Figure 15-8 · PDF p. 739 · TCP 양방향 data flow와 ACK/window advertisement의 대응</sub></p>
...
<p align="center"><sub>Figure 15-9 · PDF p. 741 · sender-side sliding window의 ACKed/in-flight/usable/cannot-send 영역</sub></p>
...
<p align="center"><sub>Figure 15-10 · PDF p. 742 · receiver-side sliding window와 duplicate/out-of-window discard 기준</sub></p>
...
<p align="center"><sub>Figure 15-11 · PDF p. 744 · receiver application이 읽지 않을 때 ACK는 전진하지만 advertised window가 감소하는 흐름</sub></p>
...
<p align="center"><sub>Figure 15-12 · PDF p. 745 · zero window 이후 application read와 window update로 전송이 재개되는 흐름</sub></p>
...
<p align="center"><sub>Figure 15-14 · PDF p. 749 · sender/receiver SWS avoidance와 persist timer가 얽힌 TCP transfer trace</sub></p>
...
<p align="center"><sub>Figure 15-15 · PDF p. 756 · Linux receiver auto-tuning이 ACK 진행에 맞춰 advertised window를 키우는 흐름</sub></p>
...
<p align="center"><sub>Figure 15-16 · PDF p. 757 · application pause로 auto-tuning이 막혔다가 read 재개 후 window가 다시 커지는 흐름</sub></p>
...
<p align="center"><sub>Figure 15-18 · PDF p. 761 · zero window 중 urgent mode 진입, URG bit, Urgent Pointer exit point가 보이는 전체 전송 흐름</sub></p>
