...
<p align="center"><img src="./images/205_Figure_7.1_page_544.png" alt="Figure 7.1" width="760"></p>
<p align="center"><sub>Figure 7.1 · PDF p. 544 · wireless host, wireless access point, coverage area, network infrastructure의 관계</sub></p>
...
<p align="center"><img src="./images/206_Figure_7.2_page_545.png" alt="Figure 7.2" width="760"></p>
<p align="center"><sub>Figure 7.2 · PDF p. 545 · WiFi, 4G/5G cellular, Bluetooth의 대략적 transmission rate와 coverage range 비교</sub></p>
...
<p align="center"><img src="./images/207_Figure_7.3_page_548.png" alt="Figure 7.3" width="661"></p>
<p align="center"><sub>Figure 7.3 · PDF p. 548 · SNR, BER, modulation technique, transmission rate의 관계</sub></p>
...
<p align="center"><img src="./images/208_Figure_7.4_page_549.png" alt="Figure 7.4" width="760"></p>
<p align="center"><sub>Figure 7.4 · PDF p. 549 · obstacle과 fading이 만드는 hidden terminal problem</sub></p>
...
<p align="center"><img src="./images/209_Figure_7.5_page_551.png" alt="Figure 7.5" width="720"></p>
<p align="center"><sub>Figure 7.5 · PDF p. 551 · 단일 sender CDMA에서 code로 data bit를 encoding하고 같은 code로 decoding하는 예</sub></p>
...
<p align="center"><img src="./images/210_Figure_7.6_page_553.png" alt="Figure 7.6" width="720"></p>
<p align="center"><sub>Figure 7.6 · PDF p. 553 · 두 sender의 signals가 더해져도 receiver가 한 sender의 code로 원래 data를 복원하는 예</sub></p>
...
<p align="center"><img src="./images/211_Figure_7.7_page_555.png" alt="Figure 7.7" width="760"></p>
<p align="center"><sub>Figure 7.7 · PDF p. 555 · AP와 BSS가 switch/router를 통해 Internet에 연결되는 IEEE 802.11 LAN architecture</sub></p>
...
<p align="center"><img src="./images/212_Figure_7.8_page_556.png" alt="Figure 7.8" width="451"></p>
<p align="center"><sub>Figure 7.8 · PDF p. 556 · 중앙 AP 없이 stations가 직접 구성하는 IEEE 802.11 ad hoc network</sub></p>
...
<p align="center"><img src="./images/213_Figure_7.9_page_558.png" alt="Figure 7.9" width="760"></p>
<p align="center"><sub>Figure 7.9 · PDF p. 558 · passive scanning과 active scanning으로 AP를 찾고 association하는 절차</sub></p>
...
<p align="center"><img src="./images/214_Figure_7.10_page_560.png" alt="Figure 7.10" width="560"></p>
<p align="center"><sub>Figure 7.10 · PDF p. 560 · DATA frame 후 SIFS를 지나 link-layer ACK를 보내는 802.11 ARQ 흐름</sub></p>
...
<p align="center"><img src="./images/215_Figure_7.11_page_562.png" alt="Figure 7.11" width="760"></p>
<p align="center"><sub>Figure 7.11 · PDF p. 562 · H1과 H2는 서로 hidden terminal이지만 둘 다 AP와 통신 가능한 상황</sub></p>
...
<p align="center"><img src="./images/216_Figure_7.12_page_563.png" alt="Figure 7.12" width="640"></p>
<p align="center"><sub>Figure 7.12 · PDF p. 563 · RTS/CTS로 hidden terminal의 전송을 defer시키고 DATA/ACK를 보호하는 흐름</sub></p>
...
<p align="center"><img src="./images/217_Figure_7.13_page_565.png" alt="Figure 7.13" width="760"></p>
<p align="center"><sub>Figure 7.13 · PDF p. 565 · 802.11 frame format과 frame control subfields</sub></p>
...
<p align="center"><img src="./images/218_Figure_7.14_page_566.png" alt="Figure 7.14" width="760"></p>
<p align="center"><sub>Figure 7.14 · PDF p. 566 · H1과 router interface R1 사이 frame 전달에서 802.11 address fields가 쓰이는 방식</sub></p>
...
<p align="center"><img src="./images/219_Figure_7.15_page_568.png" alt="Figure 7.15" width="654"></p>
<p align="center"><sub>Figure 7.15 · PDF p. 568 · 같은 subnet 안에서 H1이 AP1/BSS1에서 AP2/BSS2로 이동하는 상황</sub></p>
...
<p align="center"><img src="./images/220_Figure_7.16_page_572.png" alt="Figure 7.16" width="760"></p>
<p align="center"><sub>Figure 7.16 · PDF p. 572 · master, active clients, parked devices로 구성된 Bluetooth piconet</sub></p>
...
<p align="center"><img src="./images/221_Figure_7.17_page_576.png" alt="Figure 7.17" width="760"></p>
<p align="center"><sub>Figure 7.17 · PDF p. 576 · mobile device, base station, MME, HSS, S-GW, P-GW로 구성된 4G LTE architecture</sub></p>
...
<p align="center"><img src="./images/222_Figure_7.18_page_578.png" alt="Figure 7.18" width="760"></p>
<p align="center"><sub>Figure 7.18 · PDF p. 578 · LTE data-plane elements와 control-plane elements의 분리</sub></p>
...
<p align="center"><img src="./images/225_Figure_7.21_page_581.png" alt="Figure 7.21" width="760"></p>
<p align="center"><sub>Figure 7.21 · PDF p. 581 · LTE user-plane data path와 PDCP/RLC/MAC link-layer sublayers</sub></p>
...
<p align="center"><img src="./images/226_Figure_7.22_page_583.png" alt="Figure 7.22" width="760"></p>
<p align="center"><sub>Figure 7.22 · PDF p. 583 · 각 frequency에서 10 ms frame이 20개의 0.5 ms slots로 나뉘고, shaded slots가 한 device에 할당된 예</sub></p>
...
<p align="center"><img src="./images/227_Figure_7.23_page_585.png" alt="Figure 7.23" width="760"></p>
<p align="center"><sub>Figure 7.23 · PDF p. 585 · home cellular carrier network, visited mobile carrier network, public Internet/IPX가 연결된 global cellular data network</sub></p>
...
<p align="center"><img src="./images/228_Figure_7.24_page_590.png" alt="Figure 7.24" width="760"></p>
<p align="center"><sub>Figure 7.24 · PDF p. 590 · access network 이동, 같은 provider 내 이동, 여러 providers 사이 이동으로 나뉘는 mobility degrees</sub></p>
...
<p align="center"><img src="./images/229_Figure_7.25_page_592.png" alt="Figure 7.25" width="760"></p>
<p align="center"><sub>Figure 7.25 · PDF p. 592 · permanent IP/IMSI를 가진 mobile device와 home/visited network, mobility managers, correspondent</sub></p>
...
<p align="center"><img src="./images/230_Figure_7.26_page_594.png" alt="Figure 7.26" width="760"></p>
<p align="center"><sub>Figure 7.26 · PDF p. 594 · correspondent datagram이 home network를 거쳐 visited network로 tunnel되는 indirect routing</sub></p>
...
<p align="center"><img src="./images/231_Figure_7.27_page_597.png" alt="Figure 7.27" width="760"></p>
<p align="center"><sub>Figure 7.27 · PDF p. 597 · correspondent가 HSS를 조회한 뒤 visited network로 직접 tunnel하는 direct routing</sub></p>
...
<p align="center"><img src="./images/232_Figure_7.28_page_599.png" alt="Figure 7.28" width="760"></p>
<p align="center"><sub>Figure 7.28 · PDF p. 599 · visited network에 attach한 mobile device가 streaming 중 handover하는 4G/5G mobility scenario</sub></p>
...
<p align="center"><img src="./images/233_Figure_7.29_page_600.png" alt="Figure 7.29" width="760"></p>
<p align="center"><sub>Figure 7.29 · PDF p. 600 · visited network의 S-GW와 home network의 P-GW 사이 4G/5G tunneling</sub></p>
...
<p align="center"><img src="./images/234_Figure_7.30_page_601.png" alt="Figure 7.30" width="760"></p>
<p align="center"><sub>Figure 7.30 · PDF p. 601 · source base station에서 target base station으로 handover할 때의 tunnel 재구성 단계</sub></p>
