...
description: "Chapter 2. The Internet Address Architecture 정리 노트입니다."
tags:
  - "cs전공책"
  - "ComputerNetwork"
---
...
<p align="center"><img src="./images/008_Figure_2_1_page_74.png" alt="Figure 2-1" width="760"></p>
<p align="center"><sub>Figure 2-1 · PDF p. 74 · IPv4 classful address space에서 network/host bit가 class별로 나뉘는 방식</sub></p>
...
<p align="center"><img src="./images/009_Figure_2_2_page_76.png" alt="Figure 2-2" width="720"></p>
<p align="center"><sub>Figure 2-2 · PDF p. 76 · class B address의 host portion을 subnet ID와 host ID로 나누는 예</sub></p>
...
<p align="center"><img src="./images/010_Figure_2_3_page_77.png" alt="Figure 2-3" width="760"></p>
<p align="center"><sub>Figure 2-3 · PDF p. 77 · `128.32.0.0` class B site가 `255.255.255.0` mask로 내부 subnet을 나누는 구조</sub></p>
...
<p align="center"><img src="./images/011_Figure_2_4_page_79.png" alt="Figure 2-4" width="760"></p>
<p align="center"><sub>Figure 2-4 · PDF p. 79 · IP address와 subnet mask를 bitwise AND하여 routing prefix를 얻는 과정</sub></p>
...
<p align="center"><img src="./images/012_Figure_2_5_page_80.png" alt="Figure 2-5" width="760"></p>
<p align="center"><sub>Figure 2-5 · PDF p. 80 · 하나의 `128.32.0.0/16` site 안에서 `/24`, `/25`, `/26` subnet을 함께 쓰는 VLSM 예</sub></p>
...
<p align="center"><img src="./images/013_Figure_2_6_page_81.png" alt="Figure 2-6" width="760"></p>
<p align="center"><sub>Figure 2-6 · PDF p. 81 · subnet mask의 complement와 address를 OR하여 subnet broadcast address를 만드는 과정</sub></p>
...
<p align="center"><img src="./images/015_Figure_2_7_page_83.png" alt="Figure 2-7" width="720"></p>
<p align="center"><sub>Figure 2-7 · PDF p. 83 · EUI-48/EUI-64 구조와 IPv6 interface identifier 생성에 쓰이는 bit 의미</sub></p>
...
<p align="center"><img src="./images/016_Figure_2_8_page_88.png" alt="Figure 2-8" width="760"></p>
<p align="center"><sub>Figure 2-8 · PDF p. 88 · topology-sensitive addressing이 routing table state를 줄이는 방식</sub></p>
...
<p align="center"><img src="./images/017_Figure_2_9_page_89.png" alt="Figure 2-9" width="760"></p>
<p align="center"><sub>Figure 2-9 · PDF p. 89 · numerically adjacent prefix들을 더 짧은 aggregate prefix로 합치는 과정</sub></p>
...
<p align="center"><img src="./images/018_Figure_2_10_page_92.png" alt="Figure 2-10" width="760"></p>
<p align="center"><sub>Figure 2-10 · PDF p. 92 · IPv6 prefix 길이에 따라 IPv4 address를 IPv6 address 안에 embed하는 형식</sub></p>
...
<p align="center"><img src="./images/019_Figure_2_11_page_95.png" alt="Figure 2-11" width="680"></p>
<p align="center"><sub>Figure 2-11 · PDF p. 95 · `234/8` prefix와 unicast prefix, group ID를 결합하는 IPv4 UBM address format</sub></p>
...
<p align="center"><img src="./images/020_Figure_2_12_page_96.png" alt="Figure 2-12" width="720"></p>
<p align="center"><sub>Figure 2-12 · PDF p. 96 · IPv6 multicast base format: Flags, Scope, Group ID</sub></p>
...
<p align="center"><img src="./images/021_Figure_2_13_page_98.png" alt="Figure 2-13" width="760"></p>
<p align="center"><sub>Figure 2-13 · PDF p. 98 · unicast prefix를 포함하는 IPv6 multicast address format</sub></p>
...
<p align="center"><img src="./images/022_Figure_2_14_page_98.png" alt="Figure 2-14" width="720"></p>
<p align="center"><sub>Figure 2-14 · PDF p. 98 · link-scoped IPv6 multicast에서 IID와 group ID를 결합하는 형식</sub></p>
...
<p align="center"><img src="./images/023_Figure_2_15_page_99.png" alt="Figure 2-15" width="760"></p>
<p align="center"><sub>Figure 2-15 · PDF p. 99 · IPv6 multicast address 안에 RP 정보를 embed하는 format</sub></p>
...
<p align="center"><img src="./images/024_Figure_2_16_page_107.png" alt="Figure 2-16" width="760"></p>
<p align="center"><sub>Figure 2-16 · PDF p. 107 · public `/26` prefix, DMZ, internal NAT router를 가진 enterprise address assignment 예</sub></p>
...
<p align="center"><img src="./images/025_Figure_2_17_page_108.png" alt="Figure 2-17" width="760"></p>
<p align="center"><sub>Figure 2-17 · PDF p. 108 · multihomed enterprise에서 PA address와 PI address를 사용할 때의 routing trade-off</sub></p>
