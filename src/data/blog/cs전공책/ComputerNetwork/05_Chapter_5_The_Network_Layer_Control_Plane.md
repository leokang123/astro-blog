...
description: "Chapter 5. The Network Layer: Control Plane 정리 노트입니다."
tags:
  - "cs전공책"
  - "ComputerNetwork"
---
...
<p align="center"><img src="./images/150_Figure_5.1_page_389.png" alt="Figure 5.1" width="760"></p>
<p align="center"><sub>Figure 5.1 · PDF p. 389 · 각 router 내부 routing algorithm이 control plane에서 상호작용해 forwarding table을 만든다</sub></p>
...
<p align="center"><img src="./images/151_Figure_5.2_page_390.png" alt="Figure 5.2" width="720"></p>
<p align="center"><sub>Figure 5.2 · PDF p. 390 · logically centralized controller가 각 router의 CA와 통신해 flow table을 관리한다</sub></p>
...
<p align="center"><img src="./images/152_Figure_5.3_page_392.png" alt="Figure 5.3" width="644"></p>
<p align="center"><sub>Figure 5.3 · PDF p. 392 · routers와 links를 nodes/edges로 추상화한 routing graph</sub></p>
...
<p align="center"><img src="./images/153_Figure_5.4_page_397.png" alt="Figure 5.4" width="760"></p>
<p align="center"><sub>Figure 5.4 · PDF p. 397 · node u 기준 least-cost paths와 forwarding table의 next-hop 관계</sub></p>
...
<p align="center"><img src="./images/154_Figure_5.5_page_398.png" alt="Figure 5.5" width="720"></p>
<p align="center"><sub>Figure 5.5 · PDF p. 398 · congestion-sensitive routing에서 traffic load와 route choice가 서로 밀어내며 oscillation을 만드는 예</sub></p>
...
<p align="center"><img src="./images/155_Figure_5.6_page_402.png" alt="Figure 5.6" width="640"></p>
<p align="center"><sub>Figure 5.6 · PDF p. 402 · DV algorithm에서 neighbors의 vectors를 받아 distance table을 갱신하는 흐름</sub></p>
...
<p align="center"><img src="./images/156_Figure_5.7_page_404.png" alt="Figure 5.7" width="760"></p>
<p align="center"><sub>Figure 5.7 · PDF p. 404 · link cost 감소는 빠르게 전파되지만 cost 증가는 count-to-infinity를 만들 수 있다</sub></p>
...
<p align="center"><img src="./images/157_Figure_5.8_page_412.png" alt="Figure 5.8" width="760"></p>
<p align="center"><sub>Figure 5.8 · PDF p. 412 · AS3의 prefix x를 AS2와 AS1로 광고하는 기본 BGP 예</sub></p>
...
<p align="center"><img src="./images/158_Figure_5.9_page_413.png" alt="Figure 5.9" width="760"></p>
<p align="center"><sub>Figure 5.9 · PDF p. 413 · AS 사이 eBGP와 AS 내부 iBGP sessions가 prefix reachability를 전파한다</sub></p>
...
<p align="center"><img src="./images/159_Figure_5.10_page_414.png" alt="Figure 5.10" width="760"></p>
<p align="center"><sub>Figure 5.10 · PDF p. 414 · AS1이 prefix x로 가는 두 BGP routes와 서로 다른 NEXT-HOP을 배우는 상황</sub></p>
...
<p align="center"><img src="./images/160_Figure_5.11_page_415.png" alt="Figure 5.11" width="760"></p>
<p align="center"><sub>Figure 5.11 · PDF p. 415 · 외부 prefix를 forwarding table에 넣을 때 BGP와 intra-AS routing이 함께 쓰이는 단계</sub></p>
...
<p align="center"><img src="./images/161_Figure_5.12_page_418.png" alt="Figure 5.12" width="760"></p>
<p align="center"><sub>Figure 5.12 · PDF p. 418 · 여러 locations가 같은 IP address를 BGP로 광고하고 사용자를 가까운 server로 유도하는 IP-anycast</sub></p>
...
<p align="center"><img src="./images/162_Figure_5.13_page_419.png" alt="Figure 5.13" width="760"></p>
<p align="center"><sub>Figure 5.13 · PDF p. 419 · provider/customer 관계에서 selective route advertisement로 transit traffic을 제어하는 BGP policy 예</sub></p>
...
<p align="center"><img src="./images/163_Figure_5.14_page_424.png" alt="Figure 5.14" width="760"></p>
<p align="center"><sub>Figure 5.14 · PDF p. 424 · SDN-controlled switches, SDN controller, network-control applications의 계층 구조</sub></p>
...
<p align="center"><img src="./images/164_Figure_5.15_page_426.png" alt="Figure 5.15" width="760"></p>
<p align="center"><sub>Figure 5.15 · PDF p. 426 · communication, state management, northbound API로 나뉘는 SDN controller 구성</sub></p>
...
<p align="center"><img src="./images/165_Figure_5.16_page_429.png" alt="Figure 5.16" width="727"></p>
<p align="center"><sub>Figure 5.16 · PDF p. 429 · SDN controller에서 link-state change가 routing application과 flow table update로 이어지는 흐름</sub></p>
...
<p align="center"><img src="./images/168_Figure_5.19_page_435.png" alt="Figure 5.19" width="760"></p>
<p align="center"><sub>Figure 5.19 · PDF p. 435 · ping, unreachable, TTL expired 등 대표 ICMP type/code</sub></p>
...
<p align="center"><img src="./images/169_Figure_5.20_page_438.png" alt="Figure 5.20" width="760"></p>
<p align="center"><sub>Figure 5.20 · PDF p. 438 · managing server/controller, agents, managed devices, device data의 관계</sub></p>
...
<p align="center"><img src="./images/170_Figure_5.21_page_441.png" alt="Figure 5.21" width="760"></p>
<p align="center"><sub>Figure 5.21 · PDF p. 441 · get/set PDU와 trap PDU의 header 및 variable binding 구조</sub></p>
...
<p align="center"><img src="./images/171_Figure_5.22_page_444.png" alt="Figure 5.22" width="760"></p>
<p align="center"><sub>Figure 5.22 · PDF p. 444 · NETCONF session에서 hello, rpc/rpc-reply, notification, close-session이 오가는 흐름</sub></p>
