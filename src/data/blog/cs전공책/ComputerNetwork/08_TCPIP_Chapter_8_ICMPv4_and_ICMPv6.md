...
description: "Chapter 8. ICMPv4 and ICMPv6: Internet Control Message Protocol 정리 노트입니다."
tags:
  - "cs전공책"
  - "ComputerNetwork"
---
...
<p align="center"><img src="./images/126_Figure_8_1_page_393.png" alt="Figure 8-1" width="760"></p>
<p align="center"><sub>Figure 8-1 · PDF p. 393 · IPv4 Protocol=1, IPv6 Next Header=58로 ICMP message가 encapsulation되는 구조</sub></p>
...
<p align="center"><img src="./images/127_Figure_8_2_page_394.png" alt="Figure 8-2" width="760"></p>
<p align="center"><sub>Figure 8-2 · PDF p. 394 · ICMP 공통 header: Type, Code, Checksum 뒤에 message-specific content가 붙음</sub></p>
...
<p align="center"><img src="./images/128_Figure_8_3_page_402.png" alt="Figure 8-3" width="760"></p>
<p align="center"><sub>Figure 8-3 · PDF p. 402 · Extended ICMP message는 기본 ICMP payload 뒤에 extension header와 object들을 붙일 수 있다.</sub></p>
...
<p align="center"><img src="./images/129_Figure_8_4_page_404.png" alt="Figure 8-4" width="760"></p>
<p align="center"><sub>Figure 8-4 · PDF p. 404 · ICMPv4/ICMPv6 Destination Unreachable format과 RFC4884 Length/extension 위치.</sub></p>
...
<p align="center"><img src="./images/131_Figure_8_6_page_410.png" alt="Figure 8-6" width="720"></p>
<p align="center"><sub>Figure 8-6 · PDF p. 410 · ICMPv6 Packet Too Big은 MTU field에 next-hop MTU를 담아 PMTUD에 사용된다.</sub></p>
...
<p align="center"><img src="./images/132_Figure_8_7_page_412.png" alt="Figure 8-7" width="720"></p>
<p align="center"><sub>Figure 8-7 · PDF p. 412 · Host가 R2로 잘못 보낸 datagram을 R2가 R1으로 forwarding하면서 ICMP Redirect로 host를 교정한다.</sub></p>
...
<p align="center"><img src="./images/135_Figure_8_10_page_415.png" alt="Figure 8-10" width="720"></p>
<p align="center"><sub>Figure 8-10 · PDF p. 415 · ICMP Time Exceeded format: TTL/Hop Limit 초과(code 0)와 fragment reassembly timeout(code 1)을 표현한다.</sub></p>
...
<p align="center"><img src="./images/137_Figure_8_12_page_416.png" alt="Figure 8-12" width="760"></p>
<p align="center"><sub>Figure 8-12 · PDF p. 416 · traceroute는 TTL을 1, 2, ...로 늘린 UDP/IPv4 datagram을 보내 각 hop의 ICMPv4 Time Exceeded를 받는다.</sub></p>
...
<p align="center"><img src="./images/140_Figure_8_15_page_419.png" alt="Figure 8-15" width="720"></p>
<p align="center"><sub>Figure 8-15 · PDF p. 419 · ICMPv6 Parameter Problem은 Pointer로 오류 offset을 표시하고 code로 header/Next Header/option 문제를 구분한다.</sub></p>
...
<p align="center"><img src="./images/141_Figure_8_16_page_420.png" alt="Figure 8-16" width="720"></p>
<p align="center"><sub>Figure 8-16 · PDF p. 420 · Echo Request/Reply format: Identifier와 Sequence Number로 reply를 원래 request에 대응시킨다.</sub></p>
...
<p align="center"><img src="./images/149_Figure_8_24_page_428.png" alt="Figure 8-24" width="760"></p>
<p align="center"><sub>Figure 8-24 · PDF p. 428 · MLDv1 Query/Report/Done common format: Maximum Response Delay와 Multicast Address가 핵심이다.</sub></p>
...
<p align="center"><img src="./images/153_Figure_8_28_page_431.png" alt="Figure 8-28" width="760"></p>
<p align="center"><sub>Figure 8-28 · PDF p. 431 · MLDv2 Report는 여러 multicast address record를 vector 형태로 담는다.</sub></p>
...
<p align="center"><img src="./images/155_Figure_8_30_page_434.png" alt="Figure 8-30" width="720"></p>
<p align="center"><sub>Figure 8-30 · PDF p. 434 · MRD Advertisement는 광고 주기, QQI, Robustness Variable을 담아 multicast router 존재를 알린다.</sub></p>
...
<p align="center"><img src="./images/158_Figure_8_33_page_436.png" alt="Figure 8-33" width="760"></p>
<p align="center"><sub>Figure 8-33 · PDF p. 436 · ICMPv6 Router Advertisement는 Hop Limit, M/O/H flag, preference, lifetime, reachability timer 등을 전달한다.</sub></p>
...
<p align="center"><img src="./images/159_Figure_8_34_page_437.png" alt="Figure 8-34" width="720"></p>
<p align="center"><sub>Figure 8-34 · PDF p. 437 · Neighbor Solicitation은 Target Address를 담고, multicast 또는 unicast로 neighbor mapping/reachability를 확인한다.</sub></p>
...
<p align="center"><img src="./images/160_Figure_8_35_page_438.png" alt="Figure 8-35" width="720"></p>
<p align="center"><sub>Figure 8-35 · PDF p. 438 · Neighbor Advertisement는 R/S/O flag와 Target Address, Target Link-Layer Address option으로 mapping과 reachability를 알린다.</sub></p>
...
<p align="center"><img src="./images/162_Figure_8_37_page_441.png" alt="Figure 8-37" width="760"></p>
<p align="center"><sub>Figure 8-37 · PDF p. 441 · NUD는 neighbor cache entry를 INCOMPLETE, REACHABLE, STALE, DELAY, PROBE 상태로 관리한다.</sub></p>
...
<p align="center"><img src="./images/163_Figure_8_38_page_443.png" alt="Figure 8-38" width="760"></p>
<p align="center"><sub>Figure 8-38 · PDF p. 443 · SEND의 CGA 생성은 CGA parameters, Hash1, Hash2, Sec 값을 조합해 subnet prefix와 interface identifier를 만든다.</sub></p>
...
<p align="center"><img src="./images/166_Figure_8_41_page_447.png" alt="Figure 8-41" width="640"></p>
<p align="center"><sub>Figure 8-41 · PDF p. 447 · ND option 공통 TLV 구조: Type과 Length 뒤에 type별 contents가 붙는다.</sub></p>
...
<p align="center"><img src="./images/168_Figure_8_43_page_449.png" alt="Figure 8-43" width="760"></p>
<p align="center"><sub>Figure 8-43 · PDF p. 449 · Prefix Information option은 Prefix Length, L/A/R flag, Valid/Preferred Lifetime, Prefix를 담는다.</sub></p>
...
<p align="center"><img src="./images/175_Figure_8_50_page_454.png" alt="Figure 8-50" width="720"></p>
<p align="center"><sub>Figure 8-50 · PDF p. 454 · SEND RSA Signature option은 Key Hash와 Digital Signature를 담아 CGA owner 검증에 사용된다.</sub></p>
...
<p align="center"><img src="./images/184_Figure_8_59_page_460.png" alt="Figure 8-59" width="760"></p>
<p align="center"><sub>Figure 8-59 · PDF p. 460 · RDNSS option은 recursive DNS server IPv6 address list와 Lifetime을 RA에 실어 보낸다.</sub></p>
