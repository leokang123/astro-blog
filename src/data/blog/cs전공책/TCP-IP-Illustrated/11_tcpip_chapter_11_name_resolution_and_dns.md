...
order: 11
pubDatetime: 2026-05-16T00:11:00+09:00
modDatetime: 2026-05-16T00:11:00+09:00
description: "TCP/IP Illustrated 정리: Chapter 11. Name Resolution and DNS"
tags:
  - "ComputerNetwork"
  - "CS"
  - "TCPIP"
...
![Figure 11-1](@/assets/images/cs-tcp-ip-illustrated-216-figure-11-1-page-552.png)
*Figure 11-1 · PDF p. 552 · DNS name space는 unnamed root 아래 TLD, ccTLD, IDN ccTLD, ARPA가 놓이는 계층형 tree다*
...
![Figure 11-2](@/assets/images/cs-tcp-ip-illustrated-217-figure-11-2-page-558.png)
*Figure 11-2 · PDF p. 558 · A.HOME에서 EXAMPLE.COM 주소를 얻기 위한 recursive DNS query 흐름*
...
![Figure 11-3](@/assets/images/cs-tcp-ip-illustrated-218-figure-11-3-page-560.png)
*Figure 11-3 · PDF p. 560 · DNS fixed 12-byte header와 flags/count fields*
...
![Figure 11-4](@/assets/images/cs-tcp-ip-illustrated-219-figure-11-4-page-562.png)
*Figure 11-4 · PDF p. 562 · `www.pearson.com`을 label sequence로 encoding하는 방식*
...
![Figure 11-5](@/assets/images/cs-tcp-ip-illustrated-220-figure-11-5-page-563.png)
*Figure 11-5 · PDF p. 563 · compression label이 공통 suffix `edu`를 pointer로 재사용하는 예*
...
![Figure 11-6](@/assets/images/cs-tcp-ip-illustrated-221-figure-11-6-page-564.png)
*Figure 11-6 · PDF p. 564 · UDP/IPv4 datagram 안에 들어가는 DNS message 구조*
...
![Figure 11-7](@/assets/images/cs-tcp-ip-illustrated-222-figure-11-7-page-565.png)
*Figure 11-7 · PDF p. 565 · DNS Question section format: QNAME, QTYPE, QCLASS*
...
![Figure 11-8](@/assets/images/cs-tcp-ip-illustrated-223-figure-11-8-page-566.png)
*Figure 11-8 · PDF p. 566 · DNS Resource Record format: NAME, TYPE, CLASS, TTL, RDLENGTH, RDATA*
...
![Figure 11-9](@/assets/images/cs-tcp-ip-illustrated-224-figure-11-9-page-570.png)
*Figure 11-9 · PDF p. 570 · local DNS server GW.HOME과 ISP DNS server를 거치는 simple query/response topology*
...
![Figure 11-10](@/assets/images/cs-tcp-ip-illustrated-225-figure-11-10-page-571.png)
*Figure 11-10 · PDF p. 571 · `berkeley.edu.` IPv4 address를 묻는 UDP/IPv4 DNS standard query*
...
![Figure 11-11](@/assets/images/cs-tcp-ip-illustrated-226-figure-11-11-page-572.png)
*Figure 11-11 · PDF p. 572 · GW.HOME이 recursion 과정에서 ISP name server로 보낸 DNS request*
...
![Figure 11-12](@/assets/images/cs-tcp-ip-illustrated-227-figure-11-12-page-573.png)
*Figure 11-12 · PDF p. 573 · ISP DNS server가 GW.HOME으로 돌려준 standard DNS response*
...
![Figure 11-13](@/assets/images/cs-tcp-ip-illustrated-228-figure-11-13-page-574.png)
*Figure 11-13 · PDF p. 574 · GW.HOME이 원래 client A.HOME으로 돌려주는 recursive DNS transaction의 최종 response*
...
![Figure 11-14](@/assets/images/cs-tcp-ip-illustrated-229-figure-11-14-page-582.png)
*Figure 11-14 · PDF p. 582 · IPv6로 SOA RR을 질의했을 때 answer, authority, additional RR이 함께 오는 response*
...
![Figure 11-15](@/assets/images/cs-tcp-ip-illustrated-230-figure-11-15-page-589.png)
*Figure 11-15 · PDF p. 589 · DDDS algorithm에서 AUS에 rewrite rule을 반복 적용해 terminal result를 얻는 흐름*
...
![Figure 11-16](@/assets/images/cs-tcp-ip-illustrated-231-figure-11-16-page-596.png)
*Figure 11-16 · PDF p. 596 · `vista.dyn.home`의 A/AAAA address를 dynamic update로 등록하는 DNS UPDATE message*
...
![Figure 11-17](@/assets/images/cs-tcp-ip-illustrated-232-figure-11-17-page-597.png)
*Figure 11-17 · PDF p. 597 · dynamic update request에 대한 compact response*
...
![Figure 11-18](@/assets/images/cs-tcp-ip-illustrated-233-figure-11-18-page-598.png)
*Figure 11-18 · PDF p. 598 · DNS NOTIFY, SOA serial check, AXFR/IXFR zone transfer의 기본 관계*
...
![Figure 11-19](@/assets/images/cs-tcp-ip-illustrated-234-figure-11-19-page-599.png)
*Figure 11-19 · PDF p. 599 · TCP 위에서 type AXFR question으로 full zone transfer를 요청하는 DNS message*
...
![Figure 11-20](@/assets/images/cs-tcp-ip-illustrated-235-figure-11-20-page-600.png)
*Figure 11-20 · PDF p. 600 · AXFR response가 zone의 모든 record를 TCP connection으로 전달하는 모습*
...
![Figure 11-21](@/assets/images/cs-tcp-ip-illustrated-236-figure-11-21-page-601.png)
*Figure 11-21 · PDF p. 601 · TCP로 운반되는 IXFR request와 serial number 기반 변경 확인*
...
![Figure 11-22](@/assets/images/cs-tcp-ip-illustrated-237-figure-11-22-page-602.png)
*Figure 11-22 · PDF p. 602 · requester의 serial이 current일 때 IXFR response가 SOA만 돌려주는 경우*
...
![Figure 11-23](@/assets/images/cs-tcp-ip-illustrated-238-figure-11-23-page-603.png)
*Figure 11-23 · PDF p. 603 · zone file update를 알리는 DNS NOTIFY와 UDP retransmission 예*
...
![Figure 11-24](@/assets/images/cs-tcp-ip-illustrated-239-figure-11-24-page-605.png)
*Figure 11-24 · PDF p. 605 · 요청 source에 따라 multihomed host M의 적절한 address를 먼저 돌려줄 수 있는 enterprise topology*
...
![Figure 11-25](@/assets/images/cs-tcp-ip-illustrated-240-figure-11-25-page-608.png)
*Figure 11-25 · PDF p. 608 · DNS64가 A record를 synthetic AAAA record로 변환하고 IPv4/IPv6 translator와 함께 동작하는 구조*
